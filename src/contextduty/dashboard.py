...
_DETECTOR_LABELS: dict[str, str] = {
    ...
    "aws_mfa_serial": "AWS MFA device ARN",
    ...
    "slack_config_token": "Slack config token",
    ...
    # Databases
    "postgres_dsn": "Postgres DSN (with creds)",
    "mysql_dsn": "MySQL DSN (with creds)",
    "mongodb_dsn": "MongoDB DSN (with creds)",
    "redis_dsn": "Redis DSN (with creds)",
    "elasticsearch_dsn": "Elasticsearch DSN (with creds)",
    "sqlserver_dsn": "SQL Server DSN (with creds)",
    # Generic secrets
    ...
    "jwt_token": "JWT token",
    "basic_auth_url": "Basic-auth URL (with creds)",
    "env_secret": ".env secret variable",
    # Infrastructure as Code
    "terraform_state_secret": "Terraform state secret",
    ...
    "bitcoin_private_key_wif": "Bitcoin WIF private key",
    "mnemonic_phrase": "Seed/mnemonic phrase",
    # NLP detectors — Presidio backend (primary; see nlp/_presidio.py)
    "nlp_person": "Person name (NLP)",
    "nlp_email": "Email address (NLP)",
    "nlp_phone": "Phone number (NLP)",
    "nlp_credit_card": "Credit card (NLP)",
    "nlp_crypto_address": "Crypto address (NLP)",
    "nlp_ip_address": "IP address (NLP)",
    "nlp_iban": "IBAN (NLP)",
    "nlp_ssn": "SSN (NLP)",
    "nlp_driver_license": "Driver license (NLP)",
    "nlp_passport": "Passport (NLP)",
    "nlp_bank_account": "Bank account (NLP)",
    "nlp_itin": "ITIN (NLP)",
    "nlp_nhs_number": "NHS number (NLP)",
    "nlp_medical_license": "Medical license (NLP)",
    "nlp_url": "URL (NLP)",
    "nlp_datetime": "Date/time (NLP)",
    "nlp_nationality": "Nationality/group (NLP)",
    "nlp_location": "Location (NLP)",
    "nlp_organization": "Organization (NLP)",
    # NLP detectors — spaCy fallback backend (nlp_<label>.lower())
    "nlp_org": "Organization (NLP)",
    "nlp_date": "Date (NLP)",
    "nlp_gpe": "Location (NLP)",
    "nlp_loc": "Location (NLP)",
